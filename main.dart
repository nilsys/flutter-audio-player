...
import 'package:flutter_ui_music_player/music.dart';
      ...
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 8.0),
            WidgetPlaylistMusic(
                listMusic, widthScreen, heightScreen, paddingBottom),
          ],
        ),
      ),
    );
...
class WidgetPlaylistMusic extends StatefulWidget {
  ...
  WidgetPlaylistMusic(
      this.listMusic, this.widthScreen, this.heightScreen, this.paddingBottom);
...
class _WidgetPlaylistMusicState extends State<WidgetPlaylistMusic> {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              _showMiniPlayer(context, widget.widthScreen, widget.heightScreen,
  ...
  void _showMiniPlayer(BuildContext context, double widthScreen,
      double heightScreen, double paddingBottom, Music music) {
    showBottomSheet(
      context: context,
      builder: (context) {
        return WidgetMiniPlayer(
            music, widthScreen, heightScreen, paddingBottom);
      },
...
class WidgetMiniPlayer extends StatefulWidget {
  ...
  WidgetMiniPlayer(
      this.music, this.widthScreen, this.heightScreen, this.paddingBottom);
  ...
  Widget _buildWidgetBackgroundCoverAlbum(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image:
              AssetImage('assets/images/img_cover_album_red_taylor_swift.jpeg'),
          fit: BoxFit.cover,
        ),
      ),
      child: BackdropFilter(
